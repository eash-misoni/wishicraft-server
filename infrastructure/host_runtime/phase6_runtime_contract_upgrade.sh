...
readonly RUNTIME_ENV_PATH=/etc/wishicraft/host-runtime.env
...
main() {
  ...
  install_new "$SOURCE_ROOT/stop-v1.sh" "$STOP_PATH" 01a2aec545c177a5319d27fc4783c0d99c4d5c1194284983e59a8dd7e746ac2f 755
  install_new "$SOURCE_ROOT/rcon-secret-v1.sh" "$SECRET_PATH" 9190a684398eb4de9e6ea83e4c02a10514ae94126690eb33582a8f67856699ff 755
  ...
  replace_existing "$SOURCE_ROOT/phase6-runtime.env" "$RUNTIME_ENV_PATH" \
    "$RUNTIME_ENV_PREDECESSOR" 62c9bda48163ed1089e88f2d0bb52692372b003e225145a36512589ec6230dce 600
