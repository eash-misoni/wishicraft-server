...
readonly SECRET_PREDECESSOR=9190a684398eb4de9e6ea83e4c02a10514ae94126690eb33582a8f67856699ff
...
main() {
  ...
  replace_existing "$SOURCE_ROOT/rcon-secret-v1.sh" "$SECRET_PATH" \
    "$SECRET_PREDECESSOR" 26e4694e82b543e55050865e0babcd49b0ed038d8d248debd793d02f168a43a9 755
