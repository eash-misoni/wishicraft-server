...
readonly SECRET_PREDECESSOR=26e4694e82b543e55050865e0babcd49b0ed038d8d248debd793d02f168a43a9
...
main() {
  ...
  replace_existing "$SOURCE_ROOT/rcon-secret-v1.sh" "$SECRET_PATH" \
    "$SECRET_PREDECESSOR" 6200012f402cd7927b1eb6c51c47f38dd11db3af09ea4557f1fdf54d88ceb930 755
