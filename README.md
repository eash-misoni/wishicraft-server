...
> D-108 共通runtime memory: repository検証済み・production適用待ち。Xms 1G / Xmx 4G / container 6144MiBの設定と、digestを維持するA/B限定停止中移行。[正本・production適用状況](docs/runbooks/runtime_memory_capacity.md)。D-107のinstance/volumeは不変、D-105 positive CREATEはDeferred。
