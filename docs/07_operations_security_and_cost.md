...
D-095の隔離復元は2026-09-08復旧点のcopy上で検証済み。後日の進捗・Snapshot時点の全設定・人間目視まで復元した保証ではない。実証範囲と診断copyの扱いは[復元runbook](runbooks/backup_safety_isolated_restore.md)。共有BACKUPと切替認可は[D-097 Proposed](reviews/two_game_switch.md)、RETENTIONは引き続きdry-run-onlyである。
