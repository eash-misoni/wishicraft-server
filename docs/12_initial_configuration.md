...
> Existing Operations via Web: D-104 Accepted / production deployed, real OAuth E2E pending. [共有Admission・認可・CSRF・request/Operation契約](reviews/existing_operations_web.md)、[release/E2E/rollback](runbooks/existing_operations_web.md)。既存backend safety contractを維持する。
